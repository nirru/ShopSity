 ...
 */
public class MobikytePlaceAutoAdapter extends BaseAdapter implements Filterable{
    ...
    public MobikytePlaceAutoAdapter(Context mContext, GoogleApiClient googleApiClient,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.mobikyte_place_custom_row,parent,false);
