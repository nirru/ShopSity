...
import com.oxilo.shopsity.fragement.graph.DailyClickGraph;
 ...
 */
public class CreateClickGraph extends Job {
    ...
    public CreateClickGraph(List<ClickDatum> imprDatumList, Context mContext) {
...
//        }
//        createLineGraph();
        DailyClickGraph dailyClickGraph = new DailyClickGraph(mContext,imprDatumList);
        EventBus.getDefault().post(new DailyClickGraphFinishedEvent(dailyClickGraph.getDataSet(),dailyClickGraph.getXAxisValues()));
